# Innovation Bank — what to upload, and in what order
# بنك الابتكار — ما يُرفع، وبأي ترتيب

These are the files this institution's compliance team hands Taameem on day one.
Everything the app shows for Innovation Bank is built from exactly these files.
No other institution can see them.

## 1. Policies — `01-policies/`
8 policies, 134 numbered clauses, Arabic and English side by side.
...
- `employees.csv` — 38 people, each with a department and a role.
- `departments.csv` — 15 departments and their heads.
- `systems-register.csv` — 15 systems, who owns each and whether it holds personal data.
...
Innovation Bank is a demonstration institution. The names, systems and policy text
